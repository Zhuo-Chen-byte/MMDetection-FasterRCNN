...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(800, 800), (256, 256), (512, 512), (1024, 1024)],
    ...
    dict(type='RandomCrop', crop_size=(0.8, 0.8), crop_type='relative'),
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix='/data/zhuochen/coco/train_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
            ...
            dict(type='Pad', size_divisor=32),
            dict(
                type='RandomCrop', crop_size=(0.8, 0.8), crop_type='relative'),
            dict(type='DefaultFormatBundle'),
            dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels'])
        ],
        classes=('cancer', )),
    val=dict(
        ...
        img_prefix='/data/zhuochen/coco/test_images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
